class DropBoxController {
    ...
    constructor(){
        ...
        this.correntFolder = ['Principal'];

        this.onselectonchange = new Event('selectionchange');
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyA4LLLN0tC56boJOqj8mgPwxa1a9Vs-y4A",
            authDomain: "dropbox-clone-7b9f9.firebaseapp.com",
            databaseURL: "https://dropbox-clone-7b9f9.firebaseio.com",
            projectId: "dropbox-clone-7b9f9",
            storageBucket: "dropbox-clone-7b9f9.appspot.com",
            messagingSenderId: "884797496620",
            appId: "1:884797496620:web:21e25111d40c412a52e089",
            measurementId: "G-8E4TS7BM26"
        };
        // Initialize Firebase
    ...
    uploadComplete() {
        ...
        this.inputFilesEl.value = ''; // Zerando o campo
    ...
    readFiles() {
        ...
        this.lastFolder = this.correntFolder.join('/');
        ...
        for (let i = 0; i < this.correntFolder.length; i++){
            ...
            if ((i+1) === this.correntFolder.length) {
                ...
                span.innerHTML = `
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" class="mc-icon-template-stateless" style="top: 4px;toposition: relative;">
        ...
        li.addEventListener('click', e => {
            ...
            if(e.shiftKey){
                ...
                if (firstLi) {
                    ...
                    this.listFilesEl.dispatchEvent(this.onselectonchange);
                    return true;
                }
